...
public class GameLobby extends JPanel implements GameLobbyInter, PanelInterface {
	 ...
	 */
	private JLabel m_roomInfo, m_userInfo1, m_userInfo2, m_userInfo3;
	...
	private ImageButton m_gamer1Button, m_gamer2Button, m_gamer3Button;
	...
	private JPanel generatorGamerPanel() {
		...
		m_gamerPanel.add(m_userInfo3);
		m_userInfo3.setBounds(370,200,100,50);
		m_gamerPanel.add(m_gamer3Button);
		m_gamer3Button.setBounds(300, 50, 100, 130);

		m_gamerPanel.setLayout(null);
		m_gamerPanel.setBounds(5,5,700,245);
	...
	public void setChallenger2(String name) {
		m_userInfo3.setText(name);
		this.repaint();
	}
	...
	public String getGameInfo() {
		return m_roomInfo.getText() + "|" + m_userInfo1.getText() + 
				"|" + m_userInfo2.getText() + "|" + m_userInfo3.getText();
	}
