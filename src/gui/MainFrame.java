...
//		 when Window is Actvate, this Event call.
	...
	public void setChallenger(String string) {
		panelGameLobby.setChallenger(string);
	}
	
	public void setChallenger2(String string) {
		panelGameLobby.setChallenger2(string);
	}
